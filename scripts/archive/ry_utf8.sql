...
create table sys_dept (
  ...
  del_flag          char(1)         default '0'                comment '鍒犻櫎鏍囧織锛�0浠ｈ〃瀛樺湪 2浠ｈ〃鍒犻櫎锛�',
...
insert into sys_config values(7, '鐢ㄦ埛绠＄悊-鍒濆瀵嗙爜淇敼绛栫暐',     'sys.account.initPasswordModify',   '1',             'Y', 'admin', sysdate(), '', null, '0锛氬垵濮嬪瘑鐮佷慨鏀圭瓥鐣ュ叧闂紝娌℃湁浠讳綍鎻愮ず锛�1锛氭彁閱掔敤鎴凤紝濡傛灉鏈慨鏀瑰垵濮嬪瘑鐮侊紝鍒欏湪鐧诲綍鏃跺氨浼氭彁閱掍慨鏀瑰瘑鐮佸璇濇');
...
insert into sys_config values(9, '鐢ㄦ埛绠＄悊-瀵嗙爜瀛楃鑼冨洿',         'sys.account.chrtype',              '0',             'Y', 'admin', sysdate(), '', null, '榛樿浠绘剰瀛楃鑼冨洿锛�0浠绘剰锛堝瘑鐮佸彲浠ヨ緭鍏ヤ换鎰忓瓧绗︼級锛�1鏁板瓧锛堝瘑鐮佸彧鑳戒负0-9鏁板瓧锛夛紝2鑻辨枃瀛楁瘝锛堝瘑鐮佸彧鑳戒负a-z鍜孉-Z瀛楁瘝锛夛紝3瀛楁瘝鍜屾暟瀛楋紙瀵嗙爜蹇呴』鍖呭惈瀛楁瘝锛屾暟瀛楋級,4瀛楁瘝鏁板瓧鍜岀壒娈婂瓧绗︼紙鐩墠鏀寔鐨勭壒娈婂瓧绗﹀寘鎷細~!@#$%^&*()-=_+锛�');
...
create table gen_table (
  ...
  gen_type          char(1)         default '0'                comment '鐢熸垚浠ｇ爜鏂瑰紡锛�0zip鍘嬬缉鍖� 1鑷畾涔夎矾寰勶級',
