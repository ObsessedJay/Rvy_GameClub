...
export const constantRoutes = [
  ...
  // GameClub前台门户路由 - 公共访问（隐藏，不在后台侧边栏显示）
  {
  ...
  {
    path: '/gameclub-portal/partitions',
    component: () => import('@/views/gameclub-portal/layout/Layout'),
    hidden: true,
    children: [
      {
        path: '',
  ...
  {
    path: '/gameclub-portal/partition/:id',
    component: () => import('@/views/gameclub-portal/layout/Layout'),
    hidden: true,
    children: [
      {
  ...
  {
    path: '/gameclub-portal/apply/:guildId',
    component: () => import('@/views/gameclub-portal/layout/Layout'),
    hidden: true,
    children: [
      {
  ...
  {
    path: '/gameclub-portal/myguild/select',
    component: () => import('@/views/gameclub-portal/myGuilds/index'),
    name: 'GameClubPortalMyGuilds',
    hidden: true,
    meta: { title: '选择工会', requireAuth: true }
  },
  {
    path: '/gameclub-portal/myguild',
    component: () => import('@/views/gameclub-portal/layout/Layout'),
    hidden: true,
    children: [
      {
        path: '',
        component: () => import('@/views/gameclub-portal/myguild/index'),
        name: 'GameClubPortalMyGuild',
...
export const dynamicRoutes = [
  ...
  // GameClub用户工作台路由
  {
    ...
    component: () => import('@/views/gameclub-workspace/layout/Layout'),
